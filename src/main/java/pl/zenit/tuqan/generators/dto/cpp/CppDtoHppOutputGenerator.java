...
public class CppDtoHppOutputGenerator extends OutputGenerator {

    public CppDtoHppOutputGenerator(TuqanExecutionParameters params) {
        super(params);
    }
    ...
    private void outputScope(DefaultScope scope) throws GenerationFuckup {
        ...
        text.pushIndent();
        text.add("");
        addFieldDeclarations(text, scope);
        addGetterDeclarations(text, scope);
        addSetterDeclarations(text, scope);
        text.popIndent();
    ...
    private void addFieldDeclarations(IndentedStringList text, DefaultScope scope) {
    ...
    private void addGetterDeclarations(IndentedStringList text, DefaultScope scope) throws GenerationFuckup {
    ...
    private void addSetterDeclarations(IndentedStringList text, DefaultScope scope) throws GenerationFuckup {
        for (CppField f : scope.fields(CppField::new)) {
