...
public class CppEnumOutputGenerator extends OutputGenerator {

    public CppEnumOutputGenerator(TuqanExecutionParameters params) {
        super(params);
    }
    ...
    private void output(DefaultEnum enumData) throws GenerationFuckup {
        ...
        File headerFile = getFileFor(enumData.name() + ".hpp");
    ...
    protected File getFileFor(String filename) {
        ...
        File targetDir = new File(dtoDir, DtoDirNames.cpp);
