...
public class C99Field extends DefaultField {

    public C99Field(TuqanFieldBroker f) {
        super(f);
    }
    ...
    public String type() throws GenerationFuckup {
        switch (f.getType().getDataType()) {
            ...
            case BINARY:      return "unsigned char*";
            case ENUM:
            ...
            case CHILDREN:
                ...
                return "struct " + new DefaultScope(target2).dtoName() + "*";
        }
    }
