...
public class DelphiField extends DefaultField {

    public DelphiField(TuqanFieldBroker f) {
        super(f);
    }
    ...
    public String type() throws GenerationFuckup {
        switch (f.getType().getDataType()) {
            ...
            case CHILDREN:
                ...
                return "TList<" + new DefaultScope(target2).dtoName() + ">";
        }
    }
}
